...
const UTILITY_ASSET_ROOT = "/_utilities/astronomy";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/astronomy/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/astronomy/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("astronomy");
